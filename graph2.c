...
graph *graph_insert_edge(graph *g, node *n1, node *n2) {
        ...
        node *change_node = array_1d_inspect_value(nodes, srcidx);
		// Set neighbours.
        array_1d *neighbours = change_node->neighbours;
...
void graph_kill(graph *g) {
        ...
        for(int i = 0; i < g->n; i++) {
                ...
                node *inspected_node = array_1d_inspect_value(nodes, i);
